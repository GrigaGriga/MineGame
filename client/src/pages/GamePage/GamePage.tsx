...
>
  <Box sx={style}>
    ...
    onChange={handleAnswerChange}
     />
    <Button  variant="outlined" type="submit">Ответить</Button>
    </Box>
  </Box>
</Modal>
<Box  style={{color:'white',backgroundColor: 'rgba(0, 0, 0, 0.699',marginTop:'50px'}} component="section" sx={{ p: 2, borderBottom: '1px solid white' }}>
      Ваш счет: {score}
    </Box>
    <TableContainer style={{color:'white',backgroundColor: 'rgba(0, 0, 0, 0.699'}} component={Paper}>
